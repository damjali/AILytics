...
class SalesRecommendationPage extends StatefulWidget {
  final String predictionType;
  final String title;
  final String apiEndpoint;

  const SalesRecommendationPage({
    super.key,
  ...
  @override
  State<SalesRecommendationPage> createState() => _SalesRecommendationPageState();
}

class _SalesRecommendationPageState extends State<SalesRecommendationPage> {
