...
class RevenueRecommendationPage extends StatefulWidget {
  final String predictionType;
  final String title;
  final String apiEndpoint;

  const RevenueRecommendationPage({
    super.key,
  ...
  @override
  State<RevenueRecommendationPage> createState() => _RevenueRecommendationPageState();
}

class _RevenueRecommendationPageState extends State<RevenueRecommendationPage> {
